...
export class RecipeEditComponent implements OnInit {
  ...
  onSubmit() {
    // create recipe from formfields
    // One way => create a new recipe
    ...
    // or while the fields in the form are the same as the fields in a recipe
    // we can use this.recipeForm.value
